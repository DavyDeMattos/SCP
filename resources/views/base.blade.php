...
<header>
                ...
                <li >
                    <div class="btn-group">
                        ...
                        <ul class="dropdown-menu">
                            <li><a class="dropdown-item" href="{{route("particulier")}}">Particulier</a></li>
                            <li><a class="dropdown-item" href="{{route("entreprise")}}">Entreprise</a></li>
                            <li><a class="dropdown-item" href="{{route("collectivite")}}">Collectivités</a></li>
                        </ul>
                      </div>
                  </li>
                <li class="nav-item">
    ...
    <footer class="bg-body-tertiary text-center text-lg-start">
        ...
        <div class="container col-4"><img src="{{asset('images/logo_noir.jpg')}}" alt="Logo de l'agence" height="36"></div>
        <div class="container col-4">
            <ul>
                <li>adresse@mail.com</li>
                <li>Agence SCP<br>34 rue du mystère<br>37200 Etrangeville</li>
