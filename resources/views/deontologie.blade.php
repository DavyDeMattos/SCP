...
@section('content')
<div class="container border border-secondary-subtle border-2 my-4">
    <h1 class="my-4">Réglementation et déontologie</h1>
...
<div class="container border border-secondary-subtle border-2 mb-4">
    <h2>Responsabilité</h1>
    <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Odio quia amet sed neque cum, aspernatur tempore nihil facilis velit quos delectus et libero corporis similique optio a. Voluptates quia consequuntur possimus aspernatur ab, deserunt a quam laborum totam tenetur nemo perspiciatis mollitia in inventore quod dignissimos omnis quo ratione suscipit hic odio voluptatem sed ipsum? Porro optio voluptatibus eveniet temporibus beatae voluptates iusto modi esse, repudiandae inventore enim nemo labore doloremque voluptate obcaecati impedit consectetur nulla rem iure possimus quas quos magnam laudantium? Neque, obcaecati debitis distinctio suscipit, corporis quibusdam unde blanditiis cupiditate harum placeat facere repellendus ea recusandae quidem.</p>
</div>
<div class="container border border-secondary-subtle border-2 mb-2 d-flex flex-column flex-wrap">
    <div class="row">
        <h2 class="col-3 m-0" style="height: 45%; width:50%;">Déontologie</h1>
        <img src="https://cdn.edi-static.fr/image/upload/c_scale,f_auto,h_564,q_auto/v1/Img/FICHEPRATIQUE/2021/11/367017/Quelles-sont-obligations-professionnelles-code-deontologie--LE.jpg"  class="img-fluid col-3 m-0" alt="Photo de la déontologie" style="height: 45%; width:50%;">
        <p class="align-self-stretch col-6 m-0" style="height: 45%; width:50%;">Lorem ipsum dolor sit amet consectetur adipisicing elit. Odio quia amet sed neque cum, aspernatur tempore nihil facilis velit quos delectus et libero corporis similique optio a. Voluptates quia consequuntur possimus aspernatur ab, deserunt a quam laborum totam tenetur nemo perspiciatis mollitia in inventore quod dignissimos omnis quo ratione suscipit hic odio voluptatem sed ipsum? Porro optio voluptatibus eveniet temporibus beatae voluptates iusto modi esse, repudiandae inventore enim nemo labore doloremque voluptate obcaecati impedit consectetur nulla rem iure possimus quas quos magnam laudantium? Neque, obcaecati debitis distinctio suscipit, corporis quibusdam unde blanditiis cupiditate harum placeat facere repellendus ea recusandae quidem.</p>
    </div>
</div>
